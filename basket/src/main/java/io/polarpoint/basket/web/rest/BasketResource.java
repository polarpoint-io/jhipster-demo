...
/**
 * REST controller for managing {@link io.polarpoint.basket.domain.Basket}.
 */
@RestController
@RequestMapping("/api")
public class BasketResource {
    ...
    private static final String ENTITY_NAME = "basketBasket";
     ...
     */
    @GetMapping("/baskets")
    public ResponseEntity<List<Basket>> getAllBaskets(Pageable pageable) {
        log.debug("REST request to get a page of Baskets");
        Page<Basket> page = basketService.findAll(pageable);
