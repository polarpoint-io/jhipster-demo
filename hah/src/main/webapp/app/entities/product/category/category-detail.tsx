...
export const CategoryDetail = (props: ICategoryDetailProps) => {
  ...
  return (
    <Row>
      <Col md="8">
        <h2>
          <Translate contentKey="hahApp.productCategory.detail.title">Category</Translate> [<b>{categoryEntity.id}</b>]
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="deviceRestrictions">
              <Translate contentKey="hahApp.productCategory.deviceRestrictions">Device Restrictions</Translate>
            </span>
          </dt>
          <dd>{categoryEntity.deviceRestrictions}</dd>
          <dt>
            <Translate contentKey="hahApp.productCategory.subscriptionGroup">Subscription Group</Translate>
          </dt>
          <dd>{categoryEntity.subscriptionGroup ? categoryEntity.subscriptionGroup.id : ''}</dd>
        </dl>
