  ...
  return (
    <div>
      <h2 id="category-heading">
        <Translate contentKey="hahApp.productCategory.home.title">Categories</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="hahApp.productCategory.home.createLabel">Create new Category</Translate>
        </Link>
      </h2>
      <div className="table-responsive">
        {categoryList && categoryList.length > 0 ? (
            ...
            <tbody>
              {categoryList.map((category, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{category.deviceRestrictions}</td>
                  <td>
                    {category.subscriptionGroup ? (
                      <Link to={`subscription-group/${category.subscriptionGroup.id}`}>{category.subscriptionGroup.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
          ...
          <div className="alert alert-warning">
            <Translate contentKey="hahApp.productCategory.home.notFound">No Categories found</Translate>
          </div>
        )}
      </div>
    </div>
